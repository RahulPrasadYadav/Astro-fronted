...
const reviews: Review[] = [
  {
    ...
    rating: 5,
    review:
      "Dr. Priya gave me incredibly accurate predictions about my career. Everything she said came true within 3 months!",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "The matchmaking consultation helped me find my perfect life partner. Forever grateful to AstroXprt!",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "The remedies suggested for my business problems worked like magic. Highly recommend their services!",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Amazing accuracy in love predictions. The astrologer helped me understand my relationship better.",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "The Kundali reading was so detailed and insightful. It gave me clarity about my life path.",
    location: "Pune, India",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Excellent palm reading session. The predictions about my health were spot on and very helpful.",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "The tarot reading was incredibly accurate. It helped me make important life decisions with confidence.",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Professional and compassionate service. The spiritual healing session brought peace to my mind.",
    ...
    <div className="flex-shrink-0 w-80 bg-gradient-to-br from-astro-gold/10 to-white rounded-2xl p-6 border border-astro-gold/20 shadow-lg hover:shadow-xl transition-all duration-300 mx-4">
      ...
      <div className="flex items-center space-x-4 mb-4">
        ...
        <div className="flex-1">
          <h4 className="font-semibold text-astro-navy text-lg">
            {review.name}
          </h4>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-astro-navy/70 max-w-2xl mx-auto">
            Read authentic reviews from thousands of satisfied clients who found
            guidance, clarity, and positive changes in their lives through our
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-astro-navy mb-2">
              4.9★
            </div>
        ...
        <div className="text-center mt-12">
          <p className="text-astro-navy/70 mb-4">
            Join thousands of satisfied clients and discover your cosmic
            blueprint today
          </p>
